...
import { Abilities } from "../../build/ts/game/AbilityParser";
import Ability, { AbilityType } from "../../build/ts/game/Ability";
...
writeFileSync("./data/compiled.json", JSON.stringify(obj));
