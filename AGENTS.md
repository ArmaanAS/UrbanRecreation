...
4. Prefer fixes backed by ≥2 captured data points; note single-point hypotheses in the
   ...
   The separate Rust `CombatStatDiagnosticV1` gate is fixed at 260 unique sequential prefix rounds.
   ...
   (`334/339/343/360/570/854/3541/5532/5682`), exact structured
   ...
   provenance revision 30 records the current compiler policy. Every prefixed permanent
...
- `rust/src/engine/` keeps base rules and projected effect models separate. The 20-round
  ...
  bonus slice, and the 260-round combat-stat diagnostic adds fixed ordinary abilities,
  ...
  unconditional and reviewed conditional Victory opponent-Life, unconditional, Reprisal/Revenge and Asymmetry source Copy, unconditional stat Copy, the three reviewed Protection grammars, Attack per opposing Damage, Defeat opponent-Life, the four latched plain permanent Life grammars, plain own and opposing Victory Pillz, and ordinary numeric Support abilities without claiming general condition or full-effect parity.
