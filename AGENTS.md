...
4. Prefer fixes backed by ≥2 captured data points; note single-point hypotheses in the
   ...
   The separate Rust `CombatStatDiagnosticV1` gate is fixed at 282 unique sequential prefix rounds.
   ...
   grammar paid to a living winner (`337/455/503/1054/1150/1229/2262/2525/4855/5258`), the plain
   ability `-N Opp Pillz. Min M` grammar taken from the opposing player's post-bet Pillz
   (`334/339/343/360/570/854/3541/5532/5682`), `+1 Pillz Per Damage` (`809/1051/1090`) and
   its Symmetry form (`1852`) paid to the winner as its final resolved Damage, uncapped `+N Life
   Per Damage` (`141/189/226/492/1125/1224/4500`) with its Revenge (`1661`) and Confidence
   (`1810`) forms, exact structured
   ...
   provenance revision 32 records the current compiler policy. Every other prefixed permanent
...
- `rust/src/engine/` keeps base rules and projected effect models separate. The 20-round
  ...
  bonus slice, and the 282-round combat-stat diagnostic adds fixed ordinary abilities,
  ...
  unconditional and reviewed conditional Victory opponent-Life, unconditional, Reprisal/Revenge and Asymmetry source Copy, unconditional stat Copy, the three reviewed Protection grammars, Attack per opposing Damage, Defeat opponent-Life, the four latched plain permanent Life grammars (plain or under one Symmetry/Asymmetry/Revenge/Confidence prefix), plain own and opposing Victory Pillz, Pillz per Damage, uncapped Life per Damage, and ordinary numeric Support abilities without claiming general condition or full-effect parity.
