...
- `rust/src/advisor/` is the current-engine vertical slice: strict manual/demo/replay input, a
  ...
  hidden pillz/Fury. Blind-second remains pending. Do not present it as live-stream capture,
  refreshed opening data, blind-second, or complete TypeScript policy parity.
