...
2. **Backlog, not started: deck building for a game mode.** The owner's next bigger idea
   ...
   design, safety rules for writing decks, live checklist, questions). Never write to the
   owner's account (save, delete or set-current a deck, evolve, sell, buy) without the owner's
