...
4. Prefer fixes backed by ≥2 captured data points; note single-point hypotheses in the
   ...
   The separate Rust `CombatStatDiagnosticV1` gate is fixed at 299 unique sequential prefix rounds.
   ...
   and nothing to an owner already there - exact structured
