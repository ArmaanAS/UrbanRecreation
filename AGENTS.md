...
4. Prefer fixes backed by ≥2 captured data points; note single-point hypotheses in the
   ...
   unconditional Victory opponent-Life reductions `ability:1399`/`bonus:680`,
   ...
   provenance revision 20 records the current compiler policy. Recovery ratios, source-id
   ...
   Victory opponent-Life siblings `4708`/`4533`/`3016`/`1730`, generic capped increases,
...
- `rust/src/engine/` keeps base rules and projected effect models separate. The 20-round
  ...
  unconditional Victory opponent-Life, and ordinary numeric Support abilities without claiming general condition or full-effect parity.
